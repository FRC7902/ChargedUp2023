...
public class LeftStartStickout extends SequentialCommandGroup {
  /** Creates a new PlaceCubeOnHigh. */
  public LeftStartStickout(ArmShoulder armShoulder, ArmExtension armExtend, IntakeSubsystem intake, DriveSubsystem driveSubsystem) {
