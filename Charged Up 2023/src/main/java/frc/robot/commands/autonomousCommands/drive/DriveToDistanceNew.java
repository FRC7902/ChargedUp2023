...
public class DriveToDistanceNew extends CommandBase {
  ...
  private final PIDController drivePID = new PIDController(GainConstants.kGains_Distanc.kP, GainConstants.kGains_Distanc.kI, GainConstants.kGains_Distanc.kD);
