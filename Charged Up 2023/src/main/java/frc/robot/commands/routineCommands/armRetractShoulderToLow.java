...
public class armRetractShoulderToLow extends ParallelCommandGroup {
  ...
  public armRetractShoulderToLow(ArmShoulder armShoulder, WPI_TalonSRX armShoulderLeader, ArmExtension armExtend) {
    ...
    addCommands(new armShoulderRotateToAngle(armShoulder, armShoulderLeader, Constants.armShoulderRoutineConstants.shoulderRetractToLowAngle, -1), new armExtendToDistance(armExtend, Constants.ArmExtensionConstants.extendedMinSoftLimitInInches));
  }
}
