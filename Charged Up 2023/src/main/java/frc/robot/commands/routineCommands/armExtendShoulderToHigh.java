...
public class armExtendShoulderToHigh extends ParallelCommandGroup {
  ...
  public armExtendShoulderToHigh(ArmShoulder armShoulder, WPI_TalonSRX armShoulderLeader, ArmExtension armExtend) {
    ...
    addCommands(
        new armShoulderRotateToAngle(armShoulder, armShoulderLeader,
            Constants.armShoulderRoutineConstants.shoulderExtendToHighAngle, 1),
        new armExtendToDistance(armExtend, Constants.ArmExtensionConstants.extendedMaxSoftLimitInInches));
  }
}
