...
public class RotateLevel1 extends CommandBase {
  ...
  public RotateLevel1(ArmShoulder armShoulder) { 
  ...
  public void initialize() {
    m_armShoulder.setTargetPosition(Constants.ArmShoulderConstants.kLevel1EncoderTicks);
